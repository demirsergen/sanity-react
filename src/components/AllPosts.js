...
export default function AllPosts() {
  ...
  return (
    <div className="bg-green-100 min-h-screen p-12">
      <Link to="/About" className="border-2 p-2 ml-8">About</Link>
      <div className="container mx-auto">
        <h2 className="text-5xl flex justify-center cursive">Blog Posts</h2>
        <h3 className="text-lg text-gray-600 flex justify-center mb-12">
          I blog about things that I learn (mostly coding related atm), self-improvement and life in bits.  
        </h3>
          ...
          {allPostsData &&
            allPostsData.map((post, index) => (
              <Link to={"/" + post.slug.current} key={post.slug.current}>
                ...
                >
                  <img
                    className="w-full h-full rounded-r object-cover absolute border-green-400"
